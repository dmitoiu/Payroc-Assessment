...
export default function Home() {
    ...
    // Get voucher data
    const {loading, postsInfo} = postData;
        ...
        <>
            ...
            <div className="min-h-full">
                ...
                {typeof window !== "undefined" &&
                    <PostDialog dialogOpen={openEdit} showEditProjectDialog={setOpenEdit}/>
                }
                <Popover
                    as="header"
                    className={({ open }) =>
                                ...
                                <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                                    <div className="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2">
                                        <div className="flex flex-shrink-0 items-center">
                                            ...
                                            <h2 className={"px-2 text-3xl font-mono text-white"}>
                                                TwitStips
                                            </h2>
                                        </div>
                                    </div>
                                    ...
                                    <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                                                            ...
                                                            {({ active }) => (
                                                                <a
                                                                    ...
                                                                    className={classNames(
                                                                        active ? 'bg-stone-100' : '',
                                                                        'block py-2 px-4 text-sm text-white-700'
                                                                    )}
                                                                >
                                                                    {item.name}
                                                                </a>
                                        ...
                                        <button
                                            ...
                                            className="ml-5 inline-flex items-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2"
                                        >
                                            New Post
                                        </button>
                                        <span className="sm:ml-3">
                                              <button
                                                  ...
                                                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-rose-500"
                                              >
                                ...
                                <div className="mx-auto max-w-3xl space-y-1 px-2 pt-2 pb-3 sm:px-4">
                                    {navigation.map((item) => (
                                        <a
                                            ...
                                            className={classNames(
                                                item.current ? 'bg-stone-100 text-white-900' : 'hover:bg-gray-50',
                                    ...
                                    <div className="mx-auto mt-3 max-w-3xl space-y-1 px-2 sm:px-4">
                                        {userNavigation.map((item) => (
                                            <a
                                                key={item.name}
                                                href={item.href}
                                                className="block rounded-md py-2 px-3 text-base font-medium text-white-500 hover:bg-white-50 hover:text-white-900"
                                            >
                                                {item.name}
                                            </a>
                                        ))}
                    ...
                    <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-8 lg:px-8">
                        <div className="hidden lg:col-span-3 lg:block xl:col-span-2">
                            <nav aria-label="Sidebar" className="sticky top-4 divide-y divide-gray-300">
                                <div className="space-y-1 pb-8">
                                    {navigation.map((item) => (
                                        <a
                                            ...
                                            href={item.href}
                                            className={classNames(
                                                item.current ? 'bg-stone-200 text-stone' : 'text-white hover:bg-stone-900',
                                ...
                                <div className="pt-10">
                                    <p className="px-3 text-sm font-medium text-white" id="communities-headline">
                                        Communities
                                    </p>
                                    <div className="mt-3 space-y-2" aria-labelledby="communities-headline">
                                        {communities.map((community) => (
                                            <a
                                                key={community.name}
                                                href={community.href}
                                                className="group flex items-center rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-white-50 hover:text-white-900"
                                            >
                        ...
                        <main className="lg:col-span-9 xl:col-span-6">
                            ...
                            <SimpleBar className="mt-4 px-8" style={{height: 450}}>
                                <h1 className="sr-only">Recent questions</h1>
                                <ul role="list" className="space-y-4">
                                    {postsInfo && postsInfo.map((question) => (
                                        <li key={question.id} className="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                                            <article aria-labelledby={'question-title-' + question.id}>
                                                <div>
                                                    <div className="flex space-x-3">
                                                        <div className="flex-shrink-0">
                                                            <img className="h-10 w-10 rounded-full" src={question.members.image} alt="" />
                                                        </div>
                                                        <div className="min-w-0 flex-1">
                                                            <p className="text-sm font-medium text-gray-900">
                                                                <a href={question.members.href} className="hover:underline cursor-default">
                                                                    {question.members.name}
                                                                </a>
                                                            </p>
